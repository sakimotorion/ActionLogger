	...
	<div class="row">
		...
		<div class="col-8">
			<form class="form-adduser"
				...
				<div class="mb-3">ユーザーID : <c:out value="${userToAdd.userId}"/></div>
				<div class="mb-3">パスワード : *******</div>
				<div class="mb-3">氏名 : <c:out value="${userToAdd.name}"/></div>
				<div class="mb-3">住所 : <c:out value="${userToAdd.address}"/></div>
				<div class="mb-3">電話番号 : <c:out value="${userToAdd.tel}"/></div>
				<div class="mb-3">メールアドレス : <c:out value="${userToAdd.email}"/></div>
				<%-- フォームの正当性確認データ --%>
